...
export default function LoginPage() {
  ...
  const handleGoogle = async () => {
    ...
    catch { setError("Connexion Google annulée ou échouée"); }
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="flex flex-col items-center gap-3 mb-8 animate-fade-in-up">
        <div className="relative w-16 h-16 rounded-2xl glass-wine glow-wine flex items-center justify-center">
          <Grape className="w-8 h-8" style={{ color: "var(--cream)" }} />
        ...
        <div className="text-center">
          ...
          <p className="text-xs mt-1" style={{ color: "rgba(235,235,165,0.4)" }}>
            Carnet de vignoble
          </p>
        </div>
      </div>
      ...
      >
        <h2 className="text-base font-semibold text-center mb-5"
          style={{ color: "rgba(235,235,165,0.85)" }}>
        ...
        <button
          ...
          style={{
            background: "rgba(4,101,110,0.15)",
            border: "1px solid rgba(4,101,110,0.3)",
            color: "rgba(235,235,165,0.85)",
          }}
          onMouseEnter={e => { e.currentTarget.style.background = "rgba(4,101,110,0.25)"; }}
          onMouseLeave={e => { e.currentTarget.style.background = "rgba(4,101,110,0.15)"; }}
        >
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="flex-1 h-px" style={{ background: "rgba(235,235,165,0.08)" }} />
          <span className="text-xs" style={{ color: "rgba(235,235,165,0.25)" }}>ou</span>
          <div className="flex-1 h-px" style={{ background: "rgba(235,235,165,0.08)" }} />
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative">
            ...
            <button
              ...
              style={{ color: "rgba(235,235,165,0.25)" }}
              onMouseEnter={e => (e.currentTarget.style.color = "rgba(4,101,110,0.8)")}
          ...
          {error && (
            <p className="text-xs px-1 animate-fade-in" style={{ color: "rgba(232,100,100,0.9)" }}>
              {error}
            </p>
          )}
          ...
          <button
            ...
            disabled={submitting}
            className="w-full rounded-xl py-2.5 text-sm font-medium btn-gold
        ...
        <div className="text-center mt-5">
          <span className="text-xs" style={{ color: "rgba(235,235,165,0.3)" }}>
          ...
          <button
            ...
            onMouseLeave={e => (e.currentTarget.style.color = "var(--teal-light)")}
          >
      ...
      <p className="text-xs mt-8 animate-fade-in-up delay-2" style={{ color: "rgba(235,235,165,0.12)" }}>
        ✦ WorksVine ✦
      </p>
    </div>
  );
